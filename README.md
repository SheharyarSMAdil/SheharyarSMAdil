...
💼 Currently working as a **Manager**, leading a team of **Software & Embedded Engineers**
🧠 Tech enthusiast who loves building scalable systems & clean architectures
🎯 Obsessed with **UI/UX perfection** (yes… a bit of OCD about pixels 😄)
📈 Passionate about solving real-world problems with data, dashboards & IoT
...
* 📊 Develop **real-time dashboards** & data visualization systems
* 🔌 Work with **IoT, OPC UA & environmental monitoring systems**
* 🎨 Design clean, intuitive, and user-first interfaces
* 🧑‍🤝‍🧑 Lead teams & manage end-to-end product development
...
![](https://github-profile-trophy.vercel.app/?username=sheharyarsmadil\&theme=tokyonight\&no-frame=true\&margin-w=10)

---

## 💡 Dev Philosophy

> “"Programming isn’t about what you know; it’s about what you can figure out. Every challenge is an opportunity to grow, innovate, and create something extraordinary."”

---

## 👀 Profile Views

![](https://komarev.com/ghpvc/?username=sheharyarsmadil\&color=blueviolet\&style=flat-square)

---

✨ *Building. Leading. Designing. Improving — every single day.*
